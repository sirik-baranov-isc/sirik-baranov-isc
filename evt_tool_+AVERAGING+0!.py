...
def get_level (name):
    ...
    a=os.path.splitext(name)[0]
    pos=a.find('mm ∕ h')
    tab=pd.DataFrame({'v':[5,15,30,50],'level':[25,18,9,8]})
    v=int(a[pos-3:pos-1])
    l= tab.loc[tab['v']==v]
    level=int(l['level'])
    return (level)
...
signΔ=-1             #-1        1
lim=40000 #100000 для K 027
                      #35000  для K 011   
ph='b'                #175000 для K 054 
hyst_edge_min = 0   #160000 для K 076 (обрез)
hyst_edge_max = 130
Nbins=80
...
limY = 60
limY0 = 15
#b=-1.633123935319537e+19
#a=-1.633123935319537e+19/2
'''
@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
